...
Its main purpose is to convert the source code into CIL, It doesn't need know about the Machine type like if its (x64,x32,windows,mac)
it doesn't care about these and focus on generating a code which is common for all the machines and then it can be converted into the machine instruction.
- **CPU independent**
